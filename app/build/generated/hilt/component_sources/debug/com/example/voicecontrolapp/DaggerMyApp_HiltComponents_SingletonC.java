...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(ViewModelClass_HiltModules_KeyModule_ProvideFactory.provide());
    }
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectRecognizerSpeech(instance, singletonCImpl.recognizerSpeechProvider.get());
      MainActivity_MembersInjector.injectVoiceCommandsClass(instance, singletonCImpl.voiceCommandsClassProvider.get());
      return instance;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private Provider<ViewModelClass> viewModelClassProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.viewModelClassProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.voicecontrolapp.ViewModelClass", ((Provider) viewModelClassProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.voicecontrolapp.ViewModelClass 
          return (T) new ViewModelClass(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private Provider<RecognizerSpeech> recognizerSpeechProvider;

    private Provider<VoiceCommandsClass> voiceCommandsClassProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.recognizerSpeechProvider = DoubleCheck.provider(new SwitchingProvider<RecognizerSpeech>(singletonCImpl, 0));
      this.voiceCommandsClassProvider = DoubleCheck.provider(new SwitchingProvider<VoiceCommandsClass>(singletonCImpl, 1));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.voicecontrolapp.RecognizerSpeech 
          return (T) new RecognizerSpeech(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 1: // com.example.voicecontrolapp.VoiceCommandsClass 
          return (T) new VoiceCommandsClass(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
